secret_key = {'A':'@','B':'!','C':'#','D':'%','E':'^','F':'*','G':'&','H':'+','I':'=','J':'{','K':'~','L':'`','M':'/','N':'?','O':'[','P':']','Q':'6','R':'8','S':'9','T':'5','U':'1','V':'2','W':'3','X':'4','Y':'7','Z':'-',' ':'\\','.':'|'}
decode_key = {'@':'A','!':'B','#':'C','%':'D','^':'E','*':'F','&':'G','+':'H','=':'I','{':'J','~':'K','`':'L','/':'M','?':'N','[':'O',']':'P','6':'Q','8':'R','9':'S','5':'T','1':'U','2':'V','3':'W','4':'X','7':'Y','-':'Z','\\':' ','|':'.'}
var = ''
def print_menu():       
    print (30 * '-' , 'MENU' , 30 * '-')
